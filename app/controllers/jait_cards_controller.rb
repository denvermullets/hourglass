class JaitCardsController < ApplicationController
  ...
  def show
    ...
    render partial: "jait_cards/#{kind}", locals: { data: data, integration: @integration, team_id: team_id }
  end
  ...
  def show_by_identifier
    ...
    render partial: 'jait_cards/issue', locals: { data: data, integration: @integration, team_id: team_id }
  end
